...
Item {
    ...
    function parseStringWithSubstring(content, prefix, length) {
        // console.log("content: ",content ,"\t", "prefix: ",prefix ,"\t", "length: ", length,"\t" )
        if (prefix < 0 || length < 0 || prefix >= content.length)
            return "";
